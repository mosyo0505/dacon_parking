...
feat_names = pickle.load(open('data/feat_names_4.sav', 'rb'))

feat_names_for_val = list((set(feat_names) - set(['mean_enc_supply', 'mean_enc_region']))) + ['공급유형_merge', '지역']
...
pickle.dump(train_val_list,
            open('data/train_val_list_4.sav', 'wb'))
