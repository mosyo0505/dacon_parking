...
train_val_list = pickle.load(open('data/train_val_list_8.sav', 'rb'))
...
X_names = [x for x in train_val_list[0][1].columns if x not in ['등록차량수']]
y_names = '등록차량수'
