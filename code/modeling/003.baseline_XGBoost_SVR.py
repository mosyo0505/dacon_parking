...
#
#
#                                3. Baseline modeling : XGBoost + SVR (on server)
#
#
#
# ======================================================================================================================
...
filename = '003.baseline_XGBoost_SVR'
...
y_pred = (y_pred_xgboost + y_pred_svr)/2
...
# --------------------------------------->>> [두 prediction 간 상관성 확인]

fig, ax = plt.subplots(1, 1, figsize = (5, 5))

ax.scatter(y_pred_xgboost, y_pred_svr,
